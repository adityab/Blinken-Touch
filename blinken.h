...
Q_OBJECT
	...
	private:
		...
		QSvgRenderer *m_renderer;
                bool m_overHighscore, m_overQuit, m_overCentralText, m_overMenu, m_overAboutBlinken, m_overSettings, m_overManual, m_overLevels[3], m_overCentralLetters, m_overCounter, m_overFont, m_overSound;
